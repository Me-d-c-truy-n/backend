...
public class AudioPlugin implements ExportPluginFactory {
    ...
    private void getNovelInfo(PluginFactory plugin, String fromChapterId, int numChapters, String novelId) {
        ...
        int from = Integer.valueOf(fromChapterId.split("-")[1]).intValue();
            ...
            for (Chapter chapter : chapters) {
                ...
                for (String chunk : textChunks) {
                    String dataJson = String.format(
                            "{\"input\": {\"text\": \"%s\"}, \"voice\": {\"languageCode\": \"vi-VN\", \"name\": \"vi-VN-Standard-D\"}, \"audioConfig\": {\"audioEncoding\": \"LINEAR16\"}}",chunk
                    );
